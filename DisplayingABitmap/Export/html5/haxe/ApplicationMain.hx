...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("DisplayingABitmap", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("DisplayingABitmap", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "58";
		app.meta["company"] = "OpenFL";
		app.meta["file"] = "DisplayingABitmap";
		app.meta["name"] = "Displaying a Bitmap";
		app.meta["packageName"] = "org.openfl.samples.displayingabitmap";
